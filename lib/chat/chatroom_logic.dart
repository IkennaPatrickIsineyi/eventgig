...
class ChatRoom {
  //call the setter to init the static variables.
  static late final List allChats;
  static late final List userProfile;
  static late final bool single;
  static late final List multipleProfiles;
  static late final int idOfLastChat;
  static late final String currentRoute;
...
// List<Widget> chatContents = [];
  ...
  static setter(
    ...
    bool single,
    String currentRoute, {
    List multipleProfiles = const [],
    int idOfLastChat = 0,
  }) {
    ChatRoom.allChats = allChats;
    ChatRoom.userProfile = userProfile;
    ChatRoom.single = single;
    ChatRoom.multipleProfiles = multipleProfiles;
    ChatRoom.idOfLastChat = idOfLastChat;
    ChatRoom.currentRoute = currentRoute;
  }
